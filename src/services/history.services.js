...
const dbUpdateHistory = async (id, updateData)=>{
    ...
    return await HistoryModel.findOneAndUpdate({user: id}, updateData, {returnDocument:'after', upsert:true})
...
export {dbgetHistorybyId, dbCreateHistory,dbDeleteHistory,dbUpdateHistory,dbGetHistories}